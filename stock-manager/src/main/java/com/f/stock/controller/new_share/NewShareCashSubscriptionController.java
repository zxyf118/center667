...
@RestController
@RequestMapping("/newShare/cashSubscription")
@Api(tags = "新股管理")
public class NewShareCashSubscriptionController extends BaseController {
