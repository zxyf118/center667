...
@RestController
@RequestMapping("/newShare/zeroSubscription")
@Api(tags = "新股管理")
public class NewShareZeroSubscriptionController extends BaseController {
	...
	@ApiOperation("0元申购记录-确认缴纳")
	@PostMapping("/pay")
	@ResponseBody
	public Response<Void> pay(@ApiParam("申购记录id") @RequestParam("id") Integer id) {
		return userNewShareSubscriptionService.managerPay(id, getIp(), super.getUser().getOperator());
	}
	@ApiOperation("0元申购记录-转入持仓")
